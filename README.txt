...
Pour le moment, ce plugin est utilisé par le plugin VODINFOMAIAK et de PREPAYMENT.
...
3. Se rendre dans Configuration -> Gestion des types de transport > Aucun frais de livraison,
afin de gérer l'association au zone de transport.
